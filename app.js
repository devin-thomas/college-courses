(function () {
  ...
  function addCrossLink() {
    ...
    link.innerHTML = '<span>Full Degree Plan</span><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13.2 5.2 19 11H4v2h15l-5.8 5.8 1.4 1.4L22.8 12l-8.2-8.2-1.4 1.4Z"/></svg>';
